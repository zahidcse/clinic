...
(function () {
    function q(b) {
        ...
        g
            ...
            : (f = a
                  ? 127 < Math.max.apply(null, [a.r, a.g, a.b])
                      ? { r: 0, g: 0, b: 0 }
                      : { r: 255, g: 255, b: 255 }
                  : { r: 255, g: 255, b: 255 });
        j = function (b) {
        ...
        a && f
            ? ((b = Math.max.apply(null, [a.r, a.g, a.b])),
              (a = Math.max.apply(null, [f.r, f.g, f.b])),
              (a = Math.round(a + -0.75 * (a - b))),
              (a = { r: a, g: a, b: a }))
            : a
            ? ((a = Math.max.apply(null, [a.r, a.g, a.b])),
              (b = 1),
              127 < a && (b = -1),
              (a = Math.round(a + 96 * b)),
              (a = { r: a, g: a, b: a }))
    ...
    function m(b, j) {
        ...
        this.angleTo = function (b) {
            ...
            return 0 === j
                ...
                : Math.acos(
                      Math.min(
                          Math.max((this.x * b.x + this.y * b.y) / j, -1),
                          1
                      )
                  ) / Math.PI;
        };
    ...
    function t(b, j, a, g, c) {
        ...
        this.addToStroke = function (b) {
            if (
                ...
                "number" === typeof b.y &&
                4 <
                    Math.abs(b.x - this._lastPoint.x) +
                        Math.abs(b.y - this._lastPoint.y)
            ) {
    ...
    function r(b, j, a) {
        ...
        var g = function (b) {
                var j,
                    ...
                    g = function (g) {
                        g =
                            g.changedTouches && 0 < g.changedTouches.length
                                ? g.changedTouches[0]
                                : g;
                        return new k(
                            Math.round(g.pageX + j),
                            Math.round(g.pageY + a) + b.fatFingerCompensation
                        );
                    },
                ...
                this.drawMoveHandler = function (j) {
                    j.preventDefault();
                    b.dataEngine.inStroke &&
                        (b.dataEngine.addToStroke(g(j)), d.kick());
                };
                return this;
            }.call({}, this),
            l = g.drawEndHandler,
        ...
        this.isCanvasEmulator
            ? (j.bind("mousemove." + e, p),
              j.bind("mouseup." + e, l),
              j.bind("mousedown." + e, i))
            : ((h.ontouchstart = function (b) {
                  h.onmousedown = void 0;
                  h.onmouseup = void 0;
                  h.onmousemove = void 0;
                  this.fatFingerCompensation =
                      d.minFatFingerCompensation &&
        ...
        if ("ratio" === b || "%" === b.split("")[b.length - 1])
            this.eventTokens[w + ".parentresized"] = c.subscribe(
                w + ".parentresized",
                (function (b, j, a) {
                    return function () {
                        var g = j.width();
        ...
        v = function (b) {
            ...
            this.publish = function (b, a, g, d) {
                if (this.topics[b]) {
                    ...
                    for (h = c.length; e < h; e++)
                        (p = c[e]),
                            (i = p[0]),
                            p[1] && ((p[0] = function () {}), l.push(e)),
                            i.apply(this.context, f);
                    e = 0;
            ...
            this.unsubscribe = function (b) {
                if (this.topics[b.topic])
                    for (
                        var a = this.topics[b.topic], g = 0, d = a.length;
                        g < d;
                        g++
                    )
        ...
        u = function (b, a) {
            ...
            if (1 < a) {
                ...
                if (l.getLength() > this.lineCurveThreshold) {
                    i =
                        2 < a
                            ? new k(b.x[a - 3], b.y[a - 3]).getVectorToPoint(f)
                            : new m(0, 0);
                    var e = 0.35 * l.getLength(),
                        h = l.angleTo(i.reverse()),
                        p = c.angleTo(l.reverse());
                    i = new m(i.x + l.x, i.y + l.y).resizeTo(
                        Math.max(0.05, h) * e
                    );
                    var n = new m(l.x + c.x, l.y + c.y)
                            .reverse()
                            .resizeTo(Math.max(0.05, p) * e),
            ...
            c.getLength() <= this.lineCurveThreshold &&
        ...
        x = function (b) {
            ...
            if (0 < a) {
                ...
                if (c.getLength() > this.lineCurveThreshold) {
                    if (1 < a) {
                        var b = new k(b.x[a - 2], b.y[a - 2]).getVectorToPoint(
                                g
                            ),
                            f = new m(b.x + c.x, b.y + c.y).resizeTo(
                                c.getLength() / 2
                            ),
                            c = this.canvasContext,
                            b = g.x,
    ...
    r.prototype.resetCanvas = function (b) {
        ...
        f ||
            ...
            (c.shadowOffsetY = -0.6 * c.lineWidth),
            (c.shadowBlur = 0));
        b || (b = []);
    ...
    r.prototype.initializeCanvas = function (b) {
        ...
        c.css("margin", 0)
            ...
            .css(
                "height",
                "ratio" === b.height || !b.height ? 1 : b.height.toString(10)
            )
            .css(
                "width",
                "ratio" === b.width || !b.width ? 1 : b.width.toString(10)
            );
        c.appendTo(this.$parent);
        "ratio" === b.height
            ? c.css("height", Math.round(c.width() / b.sizeRatio))
            : "ratio" === b.width &&
              c.css("width", Math.round(c.height() * b.sizeRatio));
        c.addClass(e);
        a.width = c.width();
        a.height = c.height();
        b = a;
        if (b.getContext) b = !1;
            ...
            var c = b.ownerDocument.parentWindow,
                d = c.FlashCanvas
                    ? b.ownerDocument.parentWindow.FlashCanvas
            ...
            if (d) {
                ...
                c &&
                    c.screen &&
                    c.screen.deviceXDPI &&
                    c.screen.logicalXDPI &&
                    (d = (1 * c.screen.deviceXDPI) / c.screen.logicalXDPI);
                if (1 !== d)
                    try {
                        $(b)
                            .children("object")
        ...
        h = function (b, a) {
            ...
            c.onload = function () {
                d.getContext("2d").drawImage(
                    ...
                    0,
                    0,
                    c.width < d.width ? c.width : d.width,
                    c.height < d.height ? c.height : d.height
                );
            };
            c.src = "data:" + a + "," + b;
        },
    ...
    var w = {},
        ...
        B = { export: A, import: n, instance: w },
        C = {
            init: function (b) {
            ...
            getSettings: function () {
                return this.find("canvas." + e)
                    .add(this.filter("canvas." + e))
                    .data(e + ".this").settings;
            },
            clear: a,
            reset: a,
            ...
            getData: function (b) {
                var a = this.find("canvas." + e).add(
                    this.filter("canvas." + e)
                );
                void 0 === b && (b = "default");
    ...
    $.fn.jSignature("addPlugin", "instance", "UndoButton", function (q) {
        this.events.subscribe("jSignature.attachingEventHandlers", function () {
            if (this.settings[q]) {
                ...
                var r = this,
                    e =
                        (this.events.topics.hasOwnProperty("jSignature.undo")
                            ? q
                            : "jSignature") + ".undo";
...
(function () {
    ...
    var e = function (e) {
        ...
        y = function (k) {
            for (
                var h = [], a = 0, f = 1, d = k.length, c, l, i = 0;
                i < d;
                i++
            )
                (c = Math.round(k[i])),
                    ...
                    0 > l && 0 < f
                        ? ((f = -1), h.push("Z"))
                        : 0 < l && 0 > f && ((f = 1), h.push("Y")),
                    (c = Math.abs(l)),
                    c >= t ? h.push(e(c.toString(t))) : h.push(c.toString(t));
            return h.join("");
        },
        v = function (e) {
            for (
        ...
        u = function (e) {
            for (
                var h = [], e = e.split("_"), a = e.length / 2, f = 0;
                f < a;
                f++
            )
        ...
        r = function (e, h, a) {
            "string" === typeof e &&
                ("image/jsignature;base30" ===
                    e.substring(0, 23).toLowerCase() && (e = e.substring(24)),
                a(u(e)));
        };
    if (null == this.jQuery)
        throw Error(
...
(function () {
    function q(a, f) {
        ...
        this.angleTo = function (a) {
            ...
            return 0 === d
                ...
                : Math.acos(
                      Math.min(
                          Math.max((this.x * a.x + this.y * a.y) / d, -1),
                          1
                      )
                  ) / Math.PI;
        };
    ...
    function t(a, f, d) {
        ...
        return c.getLength() > d
            ? ((d =
                  2 < f
                      ? new m(a.x[f - 3], a.y[f - 3]).getVectorToPoint(i)
                      : new q(0, 0)),
              (a = 0.35 * c.getLength()),
              (i = c.angleTo(d.reverse())),
              (f = e.angleTo(c.reverse())),
              (d = new q(d.x + c.x, d.y + c.y).resizeTo(Math.max(0.05, i) * a)),
              (e = new q(c.x + e.x, c.y + e.y)
                  .reverse()
                  .resizeTo(Math.max(0.05, f) * a)),
              (e = new q(c.x + e.x, c.y + e.y)),
              [
                  "c",
                  k(d.x, 2),
    ...
    function e(a, e, d) {
        for (
            var e = ["M", k(a.x[0] - e, 2), k(a.y[0] - d, 2)],
                d = 1,
                c = a.x.length - 1;
            d < c;
            d++
        ...
        0 < c
            ? e.push.apply(e, r(a, d, 1))
            : 0 === c && e.push.apply(e, ["l", 1, 1]);
        return e.join(" ");
    }
    function y(a) {
        var f = [
        ...
        if (0 !== c) {
            for (d = 0; d < c; d++) {
                ...
                l = { x: [], y: [] };
                for (
                    var m = void 0, b = void 0, m = 0, b = k.x.length;
                    m < b;
                    m++
                )
    ...
    var u = window;
    ("use strict");
    ("undefined" != typeof exports ? exports : u).simplify = function (
        a,
        e,
        d
    ) {
