    ...
    function () {
        ...
        w.prototype = {
            ...
            transform: function (a, b, c, d, f, g) {
                this._queue.push(e.transform, a, b, c, d, f, g);
            },
            ...
            _setCompositing: function () {
                ...
                this._globalAlpha !== this.globalAlpha &&
                    ((this._globalAlpha = this.globalAlpha),
                    a.push(e.globalAlpha, this._globalAlpha));
                this._globalCompositeOperation !==
            ...
            createLinearGradient: function (a, b, c, d) {
                (!isFinite(a) ||
                    ...
                    !isFinite(d)) &&
                    i(9);
                this._queue.push(e.createLinearGradient, a, b, c, d);
                return new r(this);
            },
            ...
            createPattern: function (a, b) {
                ...
                !p[f][d] &&
                    v[f] &&
                    (this._executeCommand(), ++q[f], (p[f][d] = !0));
                return new z(this);
            },
            _setLineStyles: function () {
                ...
                this._lineWidth !== this.lineWidth &&
                    ((this._lineWidth = this.lineWidth),
                    a.push(e.lineWidth, this._lineWidth));
                this._lineCap !== this.lineCap &&
                    ((this._lineCap = this.lineCap),
                    a.push(e.lineCap, this._lineCap));
                this._lineJoin !== this.lineJoin &&
                    ((this._lineJoin = this.lineJoin),
                    a.push(e.lineJoin, this._lineJoin));
                this._miterLimit !== this.miterLimit &&
                    ((this._miterLimit = this.miterLimit),
                    a.push(e.miterLimit, this._miterLimit));
            },
            _setShadows: function () {
                var a = this._queue;
                this._shadowOffsetX !== this.shadowOffsetX &&
                    ((this._shadowOffsetX = this.shadowOffsetX),
                    a.push(e.shadowOffsetX, this._shadowOffsetX));
                this._shadowOffsetY !== this.shadowOffsetY &&
                    ((this._shadowOffsetY = this.shadowOffsetY),
                    a.push(e.shadowOffsetY, this._shadowOffsetY));
                this._shadowBlur !== this.shadowBlur &&
                    ((this._shadowBlur = this.shadowBlur),
                    a.push(e.shadowBlur, this._shadowBlur));
                this._shadowColor !== this.shadowColor &&
                    ((this._shadowColor = this.shadowColor),
                    a.push(e.shadowColor, this._shadowColor));
            },
            ...
            _setFontStyles: function () {
                ...
                this._textAlign !== this.textAlign &&
                    ((this._textAlign = this.textAlign),
                    a.push(e.textAlign, this._textAlign));
                this._textBaseline !== this.textBaseline &&
                    ((this._textBaseline = this.textBaseline),
                    a.push(e.textBaseline, this._textBaseline));
                this._direction !== this.canvas.currentStyle.direction &&
                    ((this._direction = this.canvas.currentStyle.direction),
                    a.push(e.direction, this._direction));
            },
            ...
            drawImage: function (a, b, c, d, f, g, j, M, N) {
                ...
                !p[A][k] &&
                    v[A] &&
                    (this._executeCommand(), ++q[A], (p[A][k] = !0));
            },
                ...
                initWindow: function (a) {
                    function b() {
                        if ("complete" === a.document.readyState) {
                            ...
                            for (
                                var c = a.document.getElementsByTagName(t),
                                    d = 0,
                                    e = c.length;
                                d < e;
                                ++d
        ...
        m[J] = function (a) {
            ...
            a.innerHTML =
                ...
                ("https:" === c.location.protocol ? "https:" : "http:") +
            ...
            try {
                ...
                if (void 0 === b)
                    (d = this.canvases[a]),
                        (e = d.firstChild),
                        (k = d.ownerDocument),
                        (l = k.defaultView ? k.defaultView : k.parentWindow),
                        F(d),
                        (g = d.width),
                        (j = d.height),
                        (d.style.width = g + "px"),
                            ...
                            if ("width" === b || "height" === b) {
                                ...
                                c === d
                                    ? ((a.style[b] = d + "px"),
                                      a
                                          .getContext("2d")
                                          ._resize(a.width, a.height))
                                    : (a[b] = d);
                            }
                        }),
                        this.registeredEvents[a].push(["onpropertychange", b]),
                        d.attachEvent("onpropertychange", b),
                        (v[a] = !0),
                        "function" === typeof d.onload &&
                ...
                throw (
                    (console.log(
                        "Call to FlashCanvas.unlock had thrown an error: ",
                        n.message
                    ),
                    n)
                );
