...
<body>
                                ...
                                <div class="page-header row">
                                    <div class="header-logo-wrapper col-auto">
                                        <div class="logo-wrapper">
                                            <a href="{{ url('/dashboard') }}"><img class="img-fluid for-light"
                                                ...
                                                <ul class="nav-menus">
                                                    ...
                                                    <li class="onhover-dropdown">
                                                        <div class="notification-box">
                                                            <span class="icon-notification nav_font"><span
                                                                    class="path1"></span><span
                                                                    class="path2"></span><span
                                                                    class="path3"></span></span>
                                                            <span class="badge rounded-pill badge-primary">4
                                                            </span>
                                                        </div>
                                                            ...
                                                            <ul class="notification-box">
                                                                <li class="d-flex">
                                                                    <div class="flex-shrink-0 bg-light-primary">
                                                                        <img src="{{ asset('assets/images/dashboard/icon/wallet.png') }}"
                                                                            alt="Wallet">
                                                                    </div>
                                                                    <div class="flex-grow-1"> <a
                                                                            href="template/letter-box.html">
                                                                ...
                                                                <li class="d-flex">
                                                                    <div class="flex-shrink-0 bg-light-warning">
                                                                        <img src="{{ asset('assets/images/dashboard/icon/graph.png') }}"
                                                                            alt="Graph">
                                                                    </div>
                                                                    <div class="flex-grow-1"> <a
                                                                            href="template/letter-box.html">
                                                                ...
                                                                <li class="d-flex">
                                                                    <div class="flex-shrink-0 bg-light-tertiary">
                                                                        <img src="{{ asset('assets/images/dashboard/icon/ticket-star.png') }}"
                                                                            alt="Ticket-star">
                                                                    </div>
                                                                    <div class="flex-grow-1"> <a
                                                                            href="template/letter-box.html">
                                                                ...
                                                                <li><a class="f-w-700"
                                                                        href="template/letter-box.html">Check all
                                                                    </a></li>
                                                            </ul>
                                                        </div>
                                                    </li>
    ...
    @php $firstLevel = request()->segment(1); @endphp

    <script>
        var currentMenu = '{{ $firstLevel }}';

        console.log(currentMenu);


        $(document).ready(function() {
            // Code to be executed once the DOM is fully loaded
            $('.' + currentMenu + '-menu .sidebar-link').addClass('active');
            $('.' + currentMenu + '-menu .sidebar-submenu').css('display', 'block');
            $('.' + currentMenu + '-submenu a').addClass('dark-gray');
